...
import "./PlonkVerifier.sol"; // generated by snarkjs (PLONK)
...
contract AiOrchestrator is ReentrancyGuard {
    ...
    // Free a timed-out claim (majority proven & TTL), or immediately if this is the last unproven task.
    ...
    // Submit PLONK proof (bytes) + pubSig = [lr, steps, acc_bps]
    function submitProof(
        ...
        require(q.started, "not started");
        require(!q.closed, "closed");
        require(pubSig.length == 3, "pubSig len");
